...
struct proc {
  ...
  int  time_counter;            /* how much counts process will run*/
  int group;                  /* group of proc         */
};
...
EXTERN struct proc *rdy_tail[NQ];	/* pointers to ready list tai */
       int groupsQuants[NRGROUPS];      /* Quants of groups 0 - group A
                                                            1 - group B
                                                            2 - group C */
