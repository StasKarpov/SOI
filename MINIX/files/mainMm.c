...
/*FORWARD _PROTOTYPE( int  do_getprocnr(void)                             );*/
...
/*============================================*/
PUBLIC int do_setquant(void)
{

  message m = mm_in;
  return _taskcall(SYSTASK, SYS_SETQUANT, &m);
}

PUBLIC int do_setgrp(void)
{
  message m = mm_in;
  return _taskcall(SYSTASK, SYS_SETGRP, &m);
}

PUBLIC int do_getgrp(void)
{
   message m = mm_in;
   return _taskcall(SYSTASK, SYS_GETGRP, &m);
}
PUBLIC int do_getquant(void)
{  
   message m = mm_in;
   return _taskcall(SYSTASK, SYS_GETQUANT, &m);
}
